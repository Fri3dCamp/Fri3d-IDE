...
import { Download, Loader2, RefreshCw, Search, Store } from 'lucide-react'
...
function BadgeHubBrowserDialog({ close }: { close: (r: null) => void }) {
    const { t } = useTranslation()
...
export function useBadgeHubBrowserDialog(): () => Promise<null> {
    const openDialog = useOpenDialog()
    return async () => openDialog<null>((close) => <BadgeHubBrowserDialog close={close} />, { wide: true })
}
